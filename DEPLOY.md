...
|------|---------|----------|------|
| Reasoning (RAG, answers) | Ollama: gpt-oss:120b | Groq: llama-3.3-70b-versatile | Free (Ollama) |
| Vision (images, charts) | Ollama: gemma4:31b | Mock | Free (Ollama) |
| Fast tasks (classify, rewrite, rerank) | Groq: llama-3.1-8b-instant | Ollama: gpt-oss:120b | Free (Groq) |
| Speech-to-Text | Groq: whisper-large-v3-turbo | — | $0.04/hr |
| Embeddings | Gemini: gemini-embedding-001 | Ollama: nomic-embed-text | Free (Gemini) |
